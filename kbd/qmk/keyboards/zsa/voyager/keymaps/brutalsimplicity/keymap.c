...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LBASE] = LAYOUT(
    ...
    MO(LNUM), LGUI_T(KC_ENTER), LT(LNAV,KC_BSPC), LT(LSYM,KC_SPACE)
  ),
  [LNUM] = LAYOUT(
    KC_NO,   KC_NO,   KC_NO,           KC_NO,   KC_NO, KC_NO, KC_NO,    KC_NO, KC_NO, KC_NO, KC_NO,    KC_NO,
  ...
  [LSYM] = LAYOUT(
    ...
    _______,  KC_EXLM,          KC_AT,            KC_HASH,          KC_DLR,           KC_PERC, KC_CIRC, KC_EQL,           KC_ASTR,          KC_PLUS,          KC_MINUS,         _______,
    KC_GRAVE, LGUI_T(SYM_LCBR), LALT_T(SYM_LPRN), LCTL_T(SYM_RPRN), LSFT_T(SYM_RCBR), KC_TILD, KC_AMPR, RSFT_T(SYM_UNDS), RCTL_T(SYM_DQUO), RALT_T(KC_QUOTE), RGUI_T(SYM_PIPE), KC_NO,
    _______,  KC_LBRC,          KC_LT,            KC_GT,            KC_RBRC,          KC_BSLS, KC_NO,   KC_COLN,          KC_QUES,          KC_NO,            KC_NO,            KC_NO,
    _______,  _______,          _______,          _______
  ),
  [LFN] = LAYOUT(
    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO,
    _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO, KC_F7, KC_F8, KC_F9, KC_F12, KC_NO,
    _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO, KC_NO, KC_F5, KC_F5, KC_F6, KC_F11, KC_NO,
    _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO, KC_F1, KC_F2, KC_F3, KC_F10, KC_NO,
    _______, _______, _______, _______
  ),
  [LNAV] = LAYOUT(
    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,       KC_NO, KC_NO,           KC_NO,           KC_NO,         KC_NO,            KC_NO, KC_NO,
    KC_NO, KC_NO,   KC_NO,   KC_NO,   MC_DEL_WORD, KC_NO, KC_NO,           PREV_WORD,       NEXT_WORD,     KC_NO,            KC_NO, KC_NO,
    KC_NO, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT,     KC_NO, RSFT_T(KC_LEFT), RCTL_T(KC_DOWN), RALT_T(KC_UP), RGUI_T(KC_RIGHT), KC_NO, KC_NO,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case LALT_T(SYM_LT):
            ...
            break;
        case RSFT_T(SYM_UNDS):
            if (record->event.pressed && record->tap.count) {
                tap_code16(KC_UNDS);
                return false;
            }
            break;
        case RCTL_T(SYM_DQUO):
            if (record->event.pressed && record->tap.count) {
                tap_code16(KC_DQUO);
                return false;
            }
            break;
        case RGUI_T(SYM_PIPE):
            if (record->event.pressed && record->tap.count) {
                tap_code16(KC_PIPE);
                return false;
            }
...
uint16_t achordion_timeout(uint16_t tap_hold_keycode) {
    ...
    switch (tap_hold_keycode) {
        case LT(LSYM,KC_SPACE):
        case LGUI_T(KC_ENTER):
        case LT(LNAV,KC_BSPC):
        case LPREFIX:
            return 0;
    }
    return 800;
